...
def load_excel(uploaded_file, sheet_name=None):
    ...
    try:
        # Se sheet_name è None, restituisce un dizionario con tutti i fogli
        if sheet_name is None:
            # Prima ottieni l'elenco dei fogli
            xls = pd.ExcelFile(uploaded_file)
            sheet_names = xls.sheet_names
            return sheet_names
        else:
            # Carica solo il foglio specificato
...
if uploaded_file is not None:
                ...
                with tab1:
                    ...
                    with st.sidebar:
                        ...
                        for col in selected_filter_columns:
                            # Gestione sicura dei valori unici
                            try:
                                ...
                                st.warning(f"Impossibile creare filtro per '{col}': {e}")
    ...
    3. **Visualizza i dati** nella tabella interattiva
    4. **Applica filtri** selezionando i valori desiderati nella barra laterale
